...
```mermaid
table
    title ماتریس موجودیت‌ها × فرآیندهای اصلی سازمان آتش‌نشانی
    header | موجودیت‌ها \ فرآیندها | عملیات | ایمنی و پیشگیری | برنامه‌ریزی و سرمایه انسانی | مالی و اقتصادی |
    row | شهروندان | ✔️ | ✔️ | — | — |
    row | شهرداری تبریز | ✔️ | ✔️ | ✔️ | ✔️ |
    row | سازمان‌های امدادی | ✔️ | — | — | — |
    row | پیمانکاران | — | — | — | ✔️ |
    row | کارکنان سازمان | ✔️ | — | ✔️ | ✔️ |
    row | مراکز آموزشی | — | — | ✔️ | — |
    row | مراجع قضایی / بیمه | — | ✔️ | — | — |
    row | وزارت کشور | — | — | ✔️ | — |
