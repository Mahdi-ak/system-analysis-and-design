...
```markdown
| موجودیت | شهروندان | شهرداری | عملیات | پیشگیری | مالی | برنامه‌ریزی | ایستگاه‌ها | پیمانکاران | مراجع قضایی |
|---|---|---|---|---|---|---|---|---|---|
| **شهروندان** | — | X | X | X | | | | | |
| **شهرداری** | X | — | | | X | X | | | |
| **معاونت عملیات** | X | | — | | | X | X | | |
| **معاونت ایمنی و پیشگیری** | X | | | — | | | | | X |
| **معاونت مالی و اقتصادی** | | X | | | — | | | X | |
| **معاونت برنامه‌ریزی** | | X | X | | | — | | | |
| **ایستگاه‌های آتش‌نشانی** | | | X | | | | — | | |
| **پیمانکاران** | | | | | X | | | — | |
| **مراجع قضایی / بیمه** | | | | X | | | | | — |
